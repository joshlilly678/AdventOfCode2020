...
def getInitialBounds(inputFile):
    # bounds = [x_start, x_size, y_start, y_size, z_start, z_size]
    bounds = [0, len(inputFile[0]), 0, len(inputFile), 0, 1]
    return bounds
...
def main():
    ...
    print("The answer to part 1 is " + str(part1(activeCoords, bounds))) 
